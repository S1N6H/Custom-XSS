...
printf "$bold$blue ** Developed by S1N6H <3 ** \n\n$end"
...
usage(){
    printf "Custom-XSS Usage:\n\n"
    printf "./Custom-XSS -d <target.com>\n"
    printf "./Custom-XSS -d <target.com> -b <blindxss.xss.ht>\n"
    printf "./Custom-XSS -d <target.com> -o xss_results.txt \n"
    printf "./Custom-XSS -d <target.com> -b <blindxss.xss.ht> -o xss_results.txt\n\n"
    exit 1;
}
...
while [ -n "$1" ]; do
        ...
        -o| --output)
            ...
            ;;
                -v|--version)
                        echo "Version of Custom-XSS: $version"
                        exit 0 ;;
                *)
